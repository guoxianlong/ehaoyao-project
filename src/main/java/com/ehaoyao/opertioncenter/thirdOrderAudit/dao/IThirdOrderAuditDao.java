package com.ehaoyao.opertioncenter.thirdOrderAudit.dao;
...
public interface IThirdOrderAuditDao {
	 ...
	 * @throws Exception
	 */
	public Object addInvoiceInfoBatch(List<InvoiceInfo> invoiceInfoList) throws Exception;
	 ...
	 * @throws Exception
	 */
	ParamConfig getParamValue(String paramType, String paramName) throws Exception;
