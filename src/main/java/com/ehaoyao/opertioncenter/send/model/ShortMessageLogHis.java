...
/**
 * 
 * Title: ShortMessageLogHis.java
 * 
 * Description: 短息历史记录
 * 
 * @author xcl
 * @version 1.0
 * @created 2014年11月18日 下午6:01:01
 */
@Entity
@Table(name = "short_message_log_his")
public class ShortMessageLogHis implements java.io.Serializable {
	private static final long serialVersionUID = 6156358858967510016L;
