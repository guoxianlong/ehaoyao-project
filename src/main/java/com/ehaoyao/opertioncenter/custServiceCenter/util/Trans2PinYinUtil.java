package com.ehaoyao.opertioncenter.custServiceCenter.util;
/**
 * 将汉字转换为拼音
 * @author bj_liuchao
 * @date 2015年9越25日
...
public class Trans2PinYinUtil {
	...
	public static void main(String[] args) {
		...
		System.out.println(Trans2PinYinUtil.getInstance().convertAll("协和医院"));
		System.out.println(Trans2PinYinUtil.getInstance().convertAll("阳光医院"));
		System.out.println(Trans2PinYinUtil.getInstance().convertAll("武警中医院"));
		System.out.println(Trans2PinYinUtil.getInstance().convertAll("中心医院"));
		System.out.println(Trans2PinYinUtil.getInstance().convertAll("第一医院"));
		System.out.println(Trans2PinYinUtil.getInstance().convertAll("第二医院"));
		System.out.println(Trans2PinYinUtil.getInstance().convertAll("第三医院"));
