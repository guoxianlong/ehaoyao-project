...
public class YTServiceNet {
	public static ReadConfigs configs = new ReadConfigs("ytoConfig");
	...
	private static final String app_key = configs.getString("app_key");
	private static final String format = "XML";
	private static final String user_id = configs.getString("user_id");
	private static String secret_key =configs.getString("secret_key");
	private static final String vision = configs.getString("vision");
	public static final String WaybillSearchMethod=configs.getString("WaybillSearchMethod");
	private static final String queryurl = configs.getString("queryurl");
