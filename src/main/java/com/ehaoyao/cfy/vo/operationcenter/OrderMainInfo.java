...
public class OrderMainInfo {
     ...
     *客服工号
     */
    private String invoiceKfAccount;
    
    /**
     * 发票状态 0：不开票 1：开票
     */
    private String invoiceInvoiceStatus;
	...
	public String getInvoiceKfAccount() {
		return invoiceKfAccount;
	}

	public void setInvoiceKfAccount(String invoiceKfAccount) {
		this.invoiceKfAccount = invoiceKfAccount;
	}

	public String getInvoiceInvoiceStatus() {
		return invoiceInvoiceStatus;
	}

	public void setInvoiceInvoiceStatus(String invoiceInvoiceStatus) {
		this.invoiceInvoiceStatus = invoiceInvoiceStatus;
	}
    ...
    public String getPayTypeDesc(){
    	...
    	if(this.payType!=null && this.payType.length()>0){
    		...
    		if(OrderInfo.ORDER_PAY_TYPE_ACCOUNTPAY.equals(this.payType)){
    			auditStatusDesc = "账户支付";
    		}
    		if(OrderInfo.ORDER_PAY_TYPE_POSTREMITTANCE.equals(this.payType)){
    			auditStatusDesc = "邮局汇款";
    		}
    		if(OrderInfo.ORDER_PAY_TYPE_BANKTRANSFER.equals(this.payType)){
    			auditStatusDesc = "银行转账";
    		}
    		if(OrderInfo.ORDER_PAY_TYPE_POSPAY.equals(this.payType)){
    			auditStatusDesc = "pos机";
    		}
    		if(OrderInfo.ORDER_PAY_TYPE_WALITO.equals(this.payType)){
    			auditStatusDesc = "万里通";
    		}
    		if(OrderInfo.ORDER_PAY_TYPE_INSTALLMENTPAYMENT.equals(this.payType)){
    			auditStatusDesc = "分期付款";
    		}
    		if(OrderInfo.ORDER_PAY_TYPE_CONTRACTPERIOD.equals(this.payType)){
    			auditStatusDesc = "合同账期";
    		}
    		if(OrderInfo.ORDER_PAY_TYPE_ARRIVALTRANSFER.equals(this.payType)){
    			auditStatusDesc = "货到转账";
    		}
    		if(OrderInfo.ORDER_PAY_TYPE_ARRIVALPAYCHECK.equals(this.payType)){
    			auditStatusDesc = "货到付支票";
    		}
    		if(OrderInfo.ORDER_PAY_TYPE_ARRIVALBRUSHALIPAY.equals(this.payType)){
    			auditStatusDesc = "货到刷支付宝";
    		}
    	}
