...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
		...
		<script src="<%=request.getContextPath()%>/js/opcenter/CMOrderAudit/CMOrderAudit.js"></script>
		
	</head>


<body style="min-height: 680px;">
	<h3 class="h3">中药订单审核管理</h3>
						...
						<div class="tab-pane fade" id="drupSelected" >
							<div class="modal-body" style="margin-bottom: 0px;padding-bottom: 0px;padding-top: 5px;" >
								...
								<div id="detailPageTbDiv" >
									<table id="detailsPageTable" class="bordered detailsPageTable" style="margin: 5px 0px 5px;width: 850px;">
										<tr>
											<th>商品编码</th>
											<th>商品名称</th>
											<th>规格</th>
							...
							<div class="modal-footer" style="height: 35px;padding-top: 8px;">
								<label style="font-size: 13px;float: left;display: none;" id="auditUserLabel">执行医师：<span id="auditUser" style="font-weight: bold;font-size: 13px;color: #428BCA;">王龙山</span></label>
