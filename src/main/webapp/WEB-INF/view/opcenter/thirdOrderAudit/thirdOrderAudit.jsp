...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
		...
		<script src="<%=request.getContextPath()%>/js/opcenter/thirdOrderAudit/thirdOrderAudit.js"></script>
			...
			<fieldset class="fieldset">
				...
				<select id="auditStatusSelect" name="auditStatus" class="selectpicker" data-hide-disabled="true" data-live-search="false">
				    <!-- <optgroup label=">审核状态"> -->
				      ...
				      <option value="PRESUCC" ${vo.auditStatus=='PRESUCC'?"selected":''} >客服审核通过</option>
							...
							<c:forEach items="${orderList}" var="items"
								...
								<tr class="orderInfoTr">
									...
									<td style="vertical-align: middle;">
										...
										<c:if test="${items.auditStatus == 'PRESUCC'}">客服审核通过</c:if> 
									...
									<td class="oprBtn">
				 						<button id="oprBtn" onclick="orderDetailsPageView('${items.orderNumber}','${items.orderFlag}');" class="button">
				 						${items.auditStatus=='WAIT'||items.auditStatus=='RETURN'?"审核":"查看"}
				 						</button>
									</td>
								</tr>
							</c:forEach>
			...
			<div class="modal-content">
				<div class="modal-header" style="padding-top:5px;padding-bottom:0px;margin-bottom:0px;height:35px;background-color: #51ABD9;">
					...
					<div class="modal-footer" style="height: 35px;padding-top: 3px;">
						<label style="font-size: 13px;float: left;display: none;" id="auditUserLabel">执行客服：<span id="auditUserDetailPage" style="font-weight: bold;font-size: 13px;color: #428BCA;"></span></label>

						<button type="button" id="succBtn" class="btn btn-primary btn-sm" onclick="auditFunc('PRESUCC')"> 通过 </button>
						<button type="button" id="retnBtn" class="btn btn-primary btn-sm" onclick="auditFunc('PRERETURN')"> 驳回 </button>
