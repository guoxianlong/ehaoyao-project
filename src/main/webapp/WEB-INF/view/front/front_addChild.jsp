...
<body>
	<form method="post" name="form" action="<%=request.getContextPath()%>/front.do?method=save&id=${parentId}">
		...
		<div class="right_box_l">
			...
			<div class="right_inline">
				...
				<input type = "hidden" name="parentId" value="${frontClass.id }" />
				<div class="right_input" style="width:300px;"><input id="parentId" name="" type="text" value="${frontClass.className}" class="form-control input-sm" readonly="readonly"></div>
			</div>
