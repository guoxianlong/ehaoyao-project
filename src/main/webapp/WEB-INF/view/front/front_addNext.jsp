...
<body>
	<form method="post" name="form" action="<%=request.getContextPath()%>/front.do?method=save1">

		<div class="right_box" id="ll">
		<div class="right_h right_bg" >前端分类信息创建</div>
			...
			<div class="right_inline">
				...
				<div class="right_input" style="width:300px;">
					<select name="parentId" class="form-control input-sm" onchange="fun(this.value)">
						<option value="${frontClass.id}">${frontClass.className}</option>
						<c:forEach items="${list}" var="goods">
							<c:if test="${frontClass.parentId != goods.id && frontClass.id != goods.id}">
