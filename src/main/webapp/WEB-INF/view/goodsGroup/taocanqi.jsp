...
<div class="right_h">
 <div class="right_h_title"> 套餐质检</div>
</div>
...
<select name="qsanj" id="qsanj" onChange="qsanji()" class="form-control input-sm" disabled="disabled">
  ...
  <div class="right_inline">
	...
	<div class="right_inline">
	  ...
	  <div class="right_input" style="width:130px;"><input id="repertoryCount" name="repertoryCount" value="${goodsGroup.repertoryCount }" type="text" class="form-control input-sm" disabled="disabled"  placeholder=" "></div></div>
	</div>
	...
	<div class="right_pic_long2" ><img class="pimg" src="${bpath1 }"  id="filepathe"  name="filepathe"  value=""  width="600" height="600"/></div>
 ...
 <span style="float:right; margin:10px 105px 0 0"></span>
  ...
  <div class="right_box_l">
        ...
        <div class="right_inline"><a  class="pull-right" style="padding-right:35px" data-toggle="modal" data-target="#editAddress">预览</a>详细介绍(HTML)</div>
...
江西副省长姚木根或涉水</div>
  ...
  <div class="right_box_l">
        ...
        <div class="right_inline"><a class="pull-right" style="padding-right:35px" data-toggle="modal" data-target="#yulan">预览</a>图文介绍（html）</div>
...
<div id="tianjia" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true"></div>
<div class="right_inline" style="padding-left:30px;">
<div class="right_title"  style="width:110px"><label class="radio-inline" >
<input type="radio" id="optionsRadios" name="optionsRadios" value="1" style="margin-top:9px;" >
   通过质检
</label>
</div>
<div class="right_title"  style="width:110px"><label class="radio-inline" >
<input type="radio" id="optionsRadios" name="optionsRadios" value="2" style="margin-top:9px;">
   未通过质检
</label>
</div>
<div class="right_input" style="width:200px;"><textarea   id="notPassCause" name="notPassCause" class="form-control input-sm" rows="4" style="width:360px;" data-bvalidator="maxlength[200]"  placeholder="未通过原因 "></textarea></div>
</div>
<p>
<div class="right_inline" style="padding-left:600px; ">
<button type="button" onclick="uptateQuality()" class="btn btn-info  btn-xs margin3 "   >质检保存</button>
