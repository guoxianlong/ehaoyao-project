...
<script language="javascript">
  ...
  //搜索
    function chang(ba){
    	...
    	document.form.action ="goodsGroup.do?method=zload&ba="+ba+"&seachCheckbo="+seachCheckbo;
		document.form.submit();
    }
  //高级搜索
   ...
   $.ajax({
    			...
    			success: function(data){
    	          ...
    	          $.each(data,function(i,result){  
	            	...
	            	document.form.action = "goodsGroup.do?method=zload";
	                document.form.submit();
	             }); 
    			}
    		});
...
//图片跳转
  function totupian(id){
	  document.form.action = "goodsImage.do?method=tcload&id="+id;
	  document.form.submit();
  }
  //审核跳转
...
<body>
<form action="goodsGroup.do?method=zload" name="form" method="post">
...
<div class="panel panel-default">
  <div class="panel-heading">
    <h5 class="panel-title" style="color:#31849b;">套餐质检查询</h5>
  </div>
  <div class="panel-body">
  	<div class="row" style="vertical-align: middle;">
	  <div class="col-xs-3" style="margin-top: 7px;">
	  	<label>商品编码或套餐名:</label>
	  </div>
	  <div class="col-xs-2" style="text-align: left;margin-left: -130px;">
	  	<input id="seachGroupName" name="seachGroupName" type="text" value="${seachGroupName }" class="form-control input-sm"  placeholder="请输入商品编码或套餐名... ">
	  </div>
	  <div class="col-xs-2" style="text-align: left;margin-top: 5px;">
...
<div class="right_box">
<%-- 
<div class="right_h">套餐质检查询</div>
<div class="right_inline"  style="min-width:800px;">
  <div class="right_title">套餐名快速搜索</div>
  
  <div class="right_input" style="width:360px;">
  	<input id="seachGroupName" name="seachGroupName" type="text" value="${seachGroupName }" class="form-control input-sm"  placeholder=" ">
  </div>
  <div class="right_input" >
   ...
   <div class="right_input" >
    <input id="seachGroupId" name="seachGroupId" type="text" class="form-control input-sm" placeholder="套餐id"   value="${seachGroupId }"/>
  </div>
  <button type="button" class="btn btn-info   btn-xs margin3"  style="width:70px;" onclick="chang('1')" >搜索</button>
  <button type="button" class="btn btn-info   btn-xs margin3"  id="productBtn"  style="width:70px;">高级</button>
...
<div class="right_title"></div>
 ...
 <div class="right_input" style="float:right">
	<sec:authorize ifAnyGranted="/goodsGroup.do?method=allplqc,/goodsGroup.do" > 
  		<button type="button" onclick="shengheplall()" class="btn btn-info   btn-xs margin3" >全部质检审核</button>
  	</sec:authorize>
  	<sec:authorize ifAnyGranted="/goodsGroup.do?method=allqc,/goodsGroup.do" >
  		<button type="button" onclick="shengheall()" class="btn btn-info   btn-xs margin3" >批量质检审核</button>
  	</sec:authorize>
 <!-- 
...
平台
 ...
 <button type="button" class="btn btn-info   btn-xs margin3" >批量下架</button>
  -->
 ...
 <table width="98%" border="0"  class="table table-striped table-bordered"  style="text-align:center"> 
  <tr>
...
-->
 ...
 <input type="checkbox" name="checkgroup" value="${item.id}">
    ...
    <c:if test="${item.groupStatus==0 }">
    	<sec:authorize ifAnyGranted="/goodsGroup.do?method=toqi,/goodsGroup.do" >
