 ...
 var qyijindex=window.document.getElementById("qyij").value;//前端选中第一级
	 ...
	 <c:forEach items="${listlableid}" var="a"> 
	  addItem('${a.labelId}', '${a.labelName}');
	    ...
	    var items="";
	   items="<tr id='${goods.id}'><td><input type='hidden' id='inputid' name='inputid' value='${goods.id}' /> <a href='javascript:goodList(${goods.id})'>${goods.goodsName}</a></td><td><input type='text' id='countid' name='${goods.id}' size='12' data-bvalidator='digit,min[1],required' /></td><td>非赠品<input type='checkbox'  checked='checked'    id='isid' name='isid' value='${goods.id}' /></td><td><c:if test='${empty goods.repertoryCount}'>0</c:if><c:if test='${not empty goods.repertoryCount}'>${goods.repertoryCount }</c:if></td><td><input type='button' class='btn btn-success   btn-xs' value='移除' onclick='getDel(${goods.id})'/></td></tr>";
...
<input type="hidden" name="dSBClassId" id="dSBClassId" value="${goods.dSBClassId }"/>
<input type="hidden" name="sfHanma" id="sfHanma" value="${goods.sfHanma }"/>
<input type="hidden" name="sfDatai" id="sfDatai" value="${goods.sfHanma }"/>
...
<div class="right_box">
<div class="right_h">
 <div class="right_h_title">生成单品套餐</div>
</div>
...
<div class="right_box2">
  ...
  <div class="right_input" style="width:300px;"><input id="mainGoodsName" name="mainGoodsName" value="${goods.goodsName }" data-bvalidator="maxlength[200],required" type="text" class="form-control input-sm" placeholder=" "></div>
  </div>
  <div class="right_inline">
  ...
  <div class="right_input" style="width:300px;"><input id="pinyinCode" name="pinyinCode" value="${goods.pinyinCode }"  data-bvalidator="maxlength[200]" type="text" class="form-control input-sm"  placeholder="普通商品的商品名"></div>
  </div>
  <div class="right_inline">
  <div class="right_title">关键词</div>
  <div class="right_input" style="width:300px;"><input id="keyWord" name="keyWord" value="${goods.keyWord }" data-bvalidator="maxlength[200]" type="text" class="form-control input-sm"  placeholder=" "></div>
  </div>
  <div class="right_inline">
  <div class="right_title">规格/型号</div>                    
  <div class="right_input" style="width:300px;"><input id="specifications" name="specifications" value="${goods.specifications }" data-bvalidator="maxlength[200]" type="text" class="form-control input-sm"  placeholder=" "></div>
  </div>
...
<select name="qsanj" id="qsanj" onChange="qsanji()" class="form-control input-sm" >
 ...
 <button type="button" onclick="save()" class="btn btn-info  btn-xs margin3 "   >套餐信息保存</button>
  ...
  <div class="right_inline">
	...
	<div class="right_inline"><div class="right_title">成本粗估</div><div class="right_input" style="width:130px;"><input id="costPrice"  value="${goods.costPrice }"  data-bvalidator="number" name="costPrice" type="text" class="form-control input-sm"  placeholder=" "></div></div>
	<div class="right_inline"><div class="right_title">建议零售价</div><div class="right_input" style="width:130px;"><input id="retailPrice" value="${goods.retailPrice }" data-bvalidator="number" name="retailPrice" type="text" class="form-control input-sm"  placeholder=" "></div></div>
	<div class="right_inline"><div class="right_title">基本定价</div><div class="right_input" style="width:130px;"><input id="basicPricing" value="${goods.basicPricing }" data-bvalidator="number" name="basicPricing" type="text" class="form-control input-sm"  placeholder=" "></div></div>
	</div>
	...
	<div class="right_inline">
	  ...
	  <div class="right_input" style="width:130px;"><input id="repertoryCount" name="repertoryCount" value="${goods.repertoryCount }" data-bvalidator="digit" type="text" class="form-control input-sm"  placeholder=" "></div></div>
	</div>
	
	<div class="right_box_3b">
	<div class="right_inline" >
	<div class="right_pic"> <img class="pimg" src="${filepatha }"  id="filepatha" name="filepatha"   value=""  width="600" height="600"/></div>
	<div class="right_pic_long2" ><img class="pimg" src="${filepathe }"  id="filepathe"  name="filepathe"  value=""  width="600" height="600"/></div>
 ...
 <span style="float:right; margin:10px 105px 0 0"></span>
  ...
  <div class="right_box_l">
		...
		<div class="right_inline"><textarea id="brief" name="brief"  rows="3" class="form-control input-sm" style="width:360px;">${goods.brief }</textarea></div>
  </div>
  
  <div class="right_box_l">
   
        <div class="right_inline">详细介绍 [自动同步主商品]</div>
		<div class="right_inline"><textarea id="goodsDetails" name="goodsDetails" class="form-control input-sm" rows="3" style="width:360px;">${goods.goodsDetails }</textarea></div>
  ...
  <div class="right_box_l">
		...
		<div class="right_inline"><textarea id="goodsDetailsHtml" name="goodsDetailsHtml" class="form-control input-sm" rows="2" style="width:360px;">${goods.goodsDetailsHtml }</textarea></div>
  ...
  <div class="right_box_l">
		...
		<div class="right_inline"><textarea id="picTextDetailsHtml" name="picTextDetailsHtml" class="form-control input-sm" rows="2" style="width:360px;">${goods.picTextDetailsHtml }</textarea></div>
