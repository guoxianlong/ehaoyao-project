...
<div class="right_box">
<div class="right_h"><h3> 商品质检审核</h3></div>
...
class="table table-striped table-bordered">
	...
	<div class="right_box2"><div class="right_box_l pull-right">
    
      <div class="right_inline" style="padding-left:30px;">
        <div class="right_title"  style="width:80px"><label class="radio-inline" 

>
  <input type="radio" id="optionsRadios" name="optionsRadios" value="0" style="margin-top:9px;" 
...
>
   ...
   <div class="right_input" style="width:200px;"><textarea id="notPassCause" name="notPassCause"  

class="form-control input-sm" rows="4" style="width:360px;" data-bvalidator="maxlength[200]" placeholder="未通过原因 "></textarea></div>
  </div>
  <!-- 
...
<button type="button" id="btnSubmit" class="btn btn-info pull-right  btn-sm" style="margin:5px 15px 0 0;">保存</button>
<button type="button" onClick="back()" class="btn btn-info pull-right  btn-sm" style="margin:5px 15px 0 0;">返回</button>
</div>
	</div></div>
