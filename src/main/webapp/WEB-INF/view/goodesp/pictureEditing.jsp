...
<body>
	...
	<div class="right_box">
    	<div class="right_h right_bg" >商品图片编辑</div>
  		...
  		<div id="picBox" class="right_box2">
    		<div class="editpic_box2">
 			...
 			<div class="right_inline">
 			    ...
 			    <input type="hidden" id="interiorCode" name="interiorCode" value="${interiorCode }"/>
 			    <c:if test="${wtype==6 }">
 ...
 function saveshezhi(){
	 ...
	 // $.blockUI({ message: "处理中，请稍候...", css: {color:'#fff',border:'3px solid #aaa',backgroundColor:'#CC3300'}});
  	 $.ajax({
    			...
    			url:"<%=request.getContextPath()%>/goodsImage.do?method=saveimageshezhi&maid="+maid+"&futuimage1="+futuimage1+"&futuimage2="+futuimage2+"&futuimage3="+futuimage3+"&futuimage4="+futuimage4+"&futuimage5="+futuimage5+"&id="+id,
    			success: function(data){
    	          $.each(data,function(i,result){  
	            	alert(result);
	            	document.shezhiform.action = "goodsImage.do?method=load&wtype=6";
	                document.shezhiform.submit();
	                 if(maid!=""){
	                 window.parent.document.getElementById("filepath").style.display="block";
	                 window.parent.document.getElementById("filepath").src=$("#mainimage").find("img").attr("src");
	                 }else{
	                 window.parent.document.getElementById("filepath").style.display="none";
	                 }
	                 if(futuimage1!=""){
	                 window.parent.document.getElementById("filepatha").style.display="block";
	                 window.parent.document.getElementById("filepatha").src=$("#futuimage1").find("img").attr("src");
	                 }else{
	                 window.parent.document.getElementById("filepatha").style.display="none";
	                 }
	                 if(futuimage2!=""){
	                 window.parent.document.getElementById("filepathb").style.display="block";
	                 window.parent.document.getElementById("filepathb").src=$("#futuimage2").find("img").attr("src");
	                 }else{
	                 window.parent.document.getElementById("filepathb").style.display="none";
	                 }
	                 if(futuimage3!=""){
	                 window.parent.document.getElementById("filepathc").style.display="block";
	                 window.parent.document.getElementById("filepathc").src=$("#futuimage3").find("img").attr("src");
	                 }else{
	                 window.parent.document.getElementById("filepathc").style.display="none";
	                 }
	                 if(futuimage4!=""){
	                 window.parent.document.getElementById("filepathd").style.display="block";
	                 window.parent.document.getElementById("filepathd").src=$("#futuimage4").find("img").attr("src");
	                 }else{
	                 window.parent.document.getElementById("filepathd").style.display="none";
	                 }
	                 if(futuimage5!=""){
	 ...
	 //document.shezhiform.action="goodsImage.do?method=saveimageshezhi&maid="+maid+"&futuimage1="+futuimage1+"&futuimage2="+futuimage2+"&futuimage3="+futuimage3+"&futuimage4="+futuimage4+"&futuimage5="+futuimage5;
	 //document.shezhiform.submit();
 }
	 ...
	 // $.blockUI({ message: "处理中，请稍候...", css: {color:'#fff',border:'3px solid #aaa',backgroundColor:'#CC3300'}});
  	 $.ajax({
    			...
    			success: function(data){
    	          ...
    	          $.each(data,function(i,result){  
	            	alert(result);
	            	document.shezhiform.action = "goodsImage.do?method=load&wtype=5";
	                document.shezhiform.submit();
	 ...
	 $(window).scroll(function(){
		...
		$('#uploadSquare').click(function(){
			...
			$('[name=square]').change(function(){
				...
				document.formSquare.action="goodsImage.do?method=saveimagez";
		...
		$('#uploadRectangle').click(function(){
			...
			$('[name=rectangle]').change(function(){
				document.formRectangle.action="goodsImage.do?method=saveimagec";
				console.log($(this).val());
