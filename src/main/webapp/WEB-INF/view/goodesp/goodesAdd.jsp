		...
		if(result){
		  $.ajax({
				...
				success: function(data){
					...
					if(data==false){
					 document.form.action = "goodsp.do?method=uploadSave&ids="+ids;
					 document.form.submit();
					}else{
						//alert("编码要唯一");
...
<div class="right_box">
<div class="right_h"><h3>添加商品</h3></div>
 ...
 <div class="right_box2"><div class="right_box_l">
  ...
  <input name="interiorCode" id="interiorCode" data-bvalidator="maxlength[200],required" onchange="onlangj()"  value="" type="text" class="form-control input-sm" placeholder=" "/>
  ...
  <div class="right_input" style="width:300px;"><input name="goodsName" id="goodsName" data-bvalidator="maxlength[200],required" value="" type="text" class="form-control input-sm"  placeholder=" "></div>
  </div>
  <div class="right_inline">
...
class="form-control input-sm"  placeholder=" 江中"></div>
  ...
  <div class="right_box2">  <div class="right_box_l">
		...
		<div class="right_inline"><textarea name="brief"  id="brief"  value="" rows="4" 
...
class="form-control input-sm" style="width:360px;"></textarea></div>
  ...
  <div class="right_box_l">
		...
		<div class="right_inline"><textarea name="goodsDetails" id="goodsDetails"  value="" class="form-control input-sm" 
...
rows="4" style="width:360px;"></textarea></div>
  ...
  <div class="right_box_l">
		...
		<div class="right_inline"><textarea name="goodsDetailsHtml" id="goodsDetailsHtml"  value="" class="form-control input-sm" 
...
rows="4" style="width:360px;"></textarea></div>
  ...
  <div class="right_box_l">
		...
		<div class="right_inline"><textarea name="picTextDetailsHtml" id="picTextDetailsHtml"  value="" class="form-control input-sm" 
...
class="form-control input-sm"  placeholder=" "></div>
  ...
  <div class="right_input"  style="width:120px;">
    ...
    <option value="2"  ${sfHanma=='2'? 'selected=selected':'' }>否</option>
    <option value="1" ${sfHanma=='1'? 'selected=selected':'' }>是</option>
  ...
  <div class="right_input"  style="width:120px;">
    ...
    <option value="2"  ${sfDatai=='2'? 'selected=selected':'' }>否</option>
    <option value="1" ${sfDatai=='1'? 'selected=selected':'' }>是</option>
...
class="form-control input-sm"  ></div>
  ...
  <div class="right_input" style="width:300px;"><input id="costPrice" name="costPrice" data-bvalidator="number" value=""  type="text" 

class="form-control input-sm" placeholder=" "></div>
  </div>
  <div class="right_inline">
  <div class="right_title">建议零售价</div>
  <div class="right_input" style="width:300px;"><input id="retailPrice" name="retailPrice" data-bvalidator="number" value=""  type="text" 

class="form-control input-sm" placeholder=" "></div>
  </div>
  <div class="right_inline">
  <div class="right_title">基本定价</div>
  <div class="right_input" style="width:300px;"><input id="basicPricing" name="basicPricing" data-bvalidator="number" value=""  type="text" 
...
style="width:100px;"><select id="salesStatus" name="salesStatus" class="form-control input-sm">
  ...
  <div class="right_input" style="width:300px;"><input  type="text" id="repertoryCount" name="repertoryCount" data-bvalidator="digit"
...
class="table table-striped table-bordered">
 ...
 <div class="right_inline">
  ...
  <div class="right_inline" style="text-align:right;">
