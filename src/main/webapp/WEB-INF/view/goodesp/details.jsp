...
function add(){
   ...
   // alert("bpath2"+bpath2);
	...
	if(confirm('你确定要提交吗？')){
		var oldinteriorCode=document.getElementById("oldinteriorCode").value;
		var	interiorCode=$.trim($('#interiorCode').val());
		...
		if(result){
		  $.ajax({
				...
				success: function(data){
		            if(interiorCode!=oldinteriorCode){
					if(data==false){
...
<div class="right_h"><h3> 商品详情</h3></div>
  <div class="right_inline"><span style="float:right"><a href="#">查看对应套餐
	...
	<select name="goodsType" id="goodsType" class="form-control input-sm">
 ...
 <div class="right_box2"><div class="right_box_l">
  ...
  <div class="right_input" style="width:300px;"><input name="interiorId" id="interiorId" value="${goods.interiorId }" type="text" class="form-control input-sm" disabled="disabled" placeholder=" "></div>
  </div>
  <div class="right_inline">
  <div class="right_title">内部编码</div>
  <div class="right_input" style="width:300px;">
  <input name="interiorCode" id="interiorCode" data-bvalidator="maxlength[200],required" value="${goods.interiorCode }" type="text" class="form-control input-sm" disabled="disabled" placeholder=" ">
  <input type="hidden" id="oldinteriorCode" name="oldinteriorCode" value="${oldinteriorCode}"/>
  </div>
  </div>
  <div class="right_inline">
  <div class="right_title">条形码</div>
  <div class="right_input" style="width:300px;"><input name="barCode" id="barCode" value="${goods.barCode }" type="text" class="form-control input-sm" disabled="disabled"  placeholder=" "></div>
  </div>
  <div class="right_inline">
  <div class="right_title">通用名</div>
  <div class="right_input" style="width:300px;"><input name="commonName" id="commonName" data-bvalidator="maxlength[200],required" value="${goods.commonName }" disabled="disabled" type="text" class="form-control input-sm"  placeholder="普通商品的商品名"></div>
  </div>
  <div class="right_inline">
  <div class="right_title">商品名</div>
  <div class="right_input" style="width:300px;"><input name="goodsName" id="goodsName" value="${goods.goodsName }" type="text" class="form-control input-sm" disabled="disabled"  placeholder=" "></div>
  </div>
  <div class="right_inline">
  <div class="right_title">英文或拼音</div>
  <div class="right_input" style="width:300px;"><input name="englishOrPinyin" id="englishOrPinyin" value="${goods.englishOrPinyin }" type="text" disabled="disabled" class="form-control input-sm"  placeholder=" "></div>
  </div>
  <div class="right_inline">
  <div class="right_title">拼音编码</div>
  <div class="right_input" style="width:300px;"><input name="pinyinCode" id="pinyinCode" value="${goods.pinyinCode }" type="text" class="form-control input-sm" disabled="disabled"  placeholder=" "></div>
  </div>
  </div>
 ...
 <span style="float:right; margin:40px 120px 0 0"></span>
 </div>
...
<option value="0">请选择</option>
  ...
  <div class="right_input" style="width:150px;">
<select id="qerj" name="qerj"  onchange="qerji()" disabled="disabled" class="form-control input-sm" >
  <option value="0">请选择</option>
</select>
  </div>
  <div class="right_title_min">三级</div>
  <div class="right_input" style="width:150px;">
<select name="qsanj" id="qsanj" onChange="qsanji()" disabled="disabled" class="form-control input-sm" >
  <option>请选择</option>
</select>
  </div></div>
  ...
  <div class="right_input" style="width:500px;"><input name="keyWord" id="keyWord" value="${goods.keyWord }" disabled="disabled" type="text" class="form-control input-sm"  placeholder=" "></div>
  </div>
  <div class="right_inline">
  <div class="right_title">规格型号</div>
  
  <div class="right_input" style="width:300px;"><input name="specifications" id="specifications" value="${goods.specifications }" disabled="disabled" type="text" class="form-control input-sm"  placeholder="纸铝复合膜包装；6包/盒、8包/盒、10包/盒

、12包/盒、14包/盒、20包/盒。 "></div>
  <div class="right_title textright">品牌</div>

 <div class="right_input" style="width:300px;"><input name="brand" id="brand" value="${goods.brand }" disabled="disabled" type="text" 
...
class="form-control input-sm"  placeholder=" 江中"></div>
  ...
  <div class="right_input" style="width:300px;"><input name="manufacturer" id="manufacturer" disabled="disabled" value="${goods.manufacturer }" type="text" 
...
class="form-control input-sm"  placeholder="
 ...
 <div class="right_input" style="width:300px;"><input name="productionAddress" id="productionAddress" disabled="disabled" value="${goods.productionAddress }" type="text" 
...
class="form-control input-sm"  placeholder=""></div>
  ...
  <div class="right_box2">  <div class="right_box_l">
		...
		<div class="right_inline"><textarea name="brief"  id="brief" disabled="disabled" value="${goods.brief }" rows="4" 

class="form-control input-sm" style="width:360px;">${goods.brief }</textarea></div>
  </div>
  
  <div class="right_box_l">
   
        <div class="right_inline">详细介绍纯文本</div>
		<div class="right_inline"><textarea name="goodsDetails" id="goodsDetails" disabled="disabled" value="${goods.goodsDetails }" class="form-control input-sm" 

rows="4" style="width:360px;">${goods.goodsDetails }</textarea></div>
...
rows="4" style="width:360px;">${goods.goodsDetailsHtml }</textarea></div>
...
rows="4" style="width:360px;">${goods.picTextDetailsHtml }</textarea></div>
...
<div id="productPanel" class="right_box2" >
  ...
  <div class="right_input" style="width:180px;">
    <select name="yij" id="yij" onChange="yiji()" disabled="disabled"  class="form-control input-sm" >
     <option value="0">请选择</option>
  ...
  <div class="right_title_min">二级</div>
  <div class="right_input" style="width:180px;">
    <select id="erj"  onchange="erji()" name="erj" disabled="disabled" class="form-control input-sm" >
     <option value="0">请选择</option>
    </select>
  </div>
  <div class="right_title_min">三级</div>
  <div class="right_input" style="width:180px;">
    <select id="sanj" onChange="sanji()" name="sanj" disabled="disabled"  class="form-control input-sm" >
      <option>请选择</option>
    </select>
  </div>
   </div>
...
style="width:150px;">
    <input name="approvalDocument" id="approvalDocument" disabled="disabled" value="${goods.approvalDocument }" type="text" class="form-control"  placeholder=" ">
  </span></div>
  <div class="right_title_min">执行标准</div>
  <div class="right_input" style="width:150px;"><input id="standard" disabled="disabled" value="${goods.standard }" name="standard" type="text" 

class="form-control input-sm"  placeholder=" "></div>
  <div class="right_title_min">卫生许可证号</div>
  <div class="right_input" style="width:150px;"><input id="hygieneLicense" disabled="disabled"  value="${goods.hygieneLicense }" name="hygieneLicense" type="text" 
...
class="form-control input-sm"  placeholder=" "></div>
  ...
  <div class="right_input"  style="width:120px;">
    <select name="prescriptionType" id="prescriptionType" disabled="disabled"  class="form-control input-sm" >
      <option value="">请选择</option>
    <c:forEach items="${listchu }" var="item">
    <option value="${item.id }" ${goods.prescriptionType == item.id? 'selected=selected':'' }>${item.attname}</option>
    </c:forEach>   
    </select>
  </div>
  ...
  <input type="checkbox" disabled="disabled"  name="gmp"  id="gmp" value="">
  </c:if>
   GMP已认证
</label>
   </div>
  ...
  <div class="right_input"  style="width:120px;">
    <select name="healthCare" id="healthCare" disabled="disabled" class="form-control input-sm" >
  ...
  <div class="right_input"  style="width:120px;">
    <select name="sfHanma" disabled="disabled" id="sfHanma" class="form-control input-sm" >
    <option value="1"${goods.sfHanma=='1'? 'selected=selected':'' }>是</option>
    <option value="2"${goods.sfHanma=='2'? 'selected=selected':'' }>否</option>
    </select>
  </div>
  <div class="right_title_min">是否打胎</div>
  <div class="right_input"  style="width:120px;">
    <select name="sfDatai" disabled="disabled" id="sfDatai" class="form-control input-sm" >
    <option value="1"${goods.sfDatai=='1'? 'selected=selected':'' }>是</option>
    <option value="2"${goods.sfDatai=='2'? 'selected=selected':'' }>否</option>
    </select>
  </div>
  </div>
  <div class="right_inline">
...
">
  ...
  <div class="right_inline">
   ...
   <div class="right_inline"><textarea id="ingredients" disabled="disabled" name="ingredients"  class="form-control input-sm" rows="4" 
...
>${goods.ingredients }</textarea></div>
   ...
   <div class="right_inline"><textarea id="tcac" name="tcac" disabled="disabled" class="form-control input-sm" rows="4" 
...
> ${goods.tcac }</textarea></div>
   ...
   <div class="right_inline"><textarea id="indication" name="indication" disabled="disabled" class="form-control input-sm" rows="4" 
>${goods.indication }</textarea></div>
   </div>
   
   <div class="right_box_3">
   <div class="right_title2"><nobr title="用法用量[药品,食品保健品,化妆品,日用品]">用法用量[药品,食品保健品,化妆品,日用品]</nobr></div>
   <div class="right_inline"><textarea id="usageAndDosage" name="usageAndDosage" disabled="disabled" class="form-control input-sm" rows="4" 

>${goods.usageAndDosage }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="不良反应[药品,器械,日用品]">不良反应[药品,器械,日用品]</nobr></div>
   <div class="right_inline"><textarea id="adverseDrugReactions" name="adverseDrugReactions" disabled="disabled" class="form-control input-sm" rows="4" 
...
>${goods.adverseDrugReactions }</textarea></div>
   ...
   <div class="right_inline"><textarea id="taboo" name="taboo" disabled="disabled" class="form-control input-sm" rows="4" 

>${goods.taboo }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="功能主治[药品]">功能主治[药品]</nobr></div>
   <div class="right_inline"><textarea id="treatment" name="treatment" disabled="disabled" class="form-control input-sm" rows="4" 

>${goods.treatment }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="药理作用[药品]">药理作用[药品]</nobr></div>
   <div class="right_inline"><textarea id="pharmacological" name="pharmacological" disabled="disabled" class="form-control input-sm" rows="4" 

>${goods.pharmacological }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="药物相互作用[药品]">药物相互作用[药品]</nobr></div>
   <div class="right_inline"><textarea id="interactions" name="interactions" disabled="disabled" class="form-control input-sm" rows="4" 

>${goods.interactions }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="药代动力学[药品]">药代动力学[药品]</nobr></div>
   <div class="right_inline"><textarea id="pharmacokinetics" name="pharmacokinetics" disabled="disabled" class="form-control input-sm" rows="4" 

>${goods.pharmacokinetics }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="特殊人群用药[药品]">特殊人群用药[药品]</nobr></div>
   <div class="right_inline"><textarea id="tsrqyy" name="tsrqyy" disabled="disabled" class="form-control input-sm" rows="4" 

>${goods.tsrqyy }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="药物过量[药品]">药物过量[药品]</nobr></div>
   <div class="right_inline"><textarea id="overdose" name="overdose" disabled="disabled" class="form-control input-sm" rows="4" 

>${goods.overdose }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="性味归经[中药]">性味归经[中药]</nobr></div>
   <div class="right_inline"><textarea id="xwgj" name="xwgj" disabled="disabled" class="form-control input-sm" rows="4" 

>${goods.xwgj }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="药理毒理[药品]">药理毒理[药品]</nobr></div>
   <div class="right_inline"><textarea id="yldl" name="yldl" disabled="disabled" class="form-control input-sm" rows="4" 

>${goods.yldl }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="说明书核准日期[药品,食品保健品,化妆品]">说明书核准日期[药品,食品保健品,化妆品]</nobr></div>
   <div class="right_inline"><textarea id="smshzrq" name="smshzrq" disabled="disabled" class="form-control input-sm" rows="4" 

>${goods.smshzrq }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="作用类别[药品,日用品,化妆品]">作用类别[药品,日用品,化妆品]</nobr></div>
   <div class="right_inline"><textarea id="categories" name="categories" disabled="disabled" class="form-control input-sm" rows="4" 

>${goods.categories }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="作用用途[化妆品,日用品] 保健作用[保健品]">作用用途[化妆品,日用品] 保健作用[保健品]</nobr></div>
   <div class="right_inline"><textarea id="purpose"  name="purpose" disabled="disabled" class="form-control input-sm" rows="4" 

>${goods.purpose }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="生产许可证号[化妆品]">生产许可证号[化妆品]</nobr></div>
   <div class="right_inline"><textarea id="license" name="license" disabled="disabled" class="form-control input-sm" rows="4" 

>${goods.license }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="适宜人群[器械,食品保健品,化妆品,日用品]">适宜人群[器械,食品保健品,化妆品,日用品]</nobr></div>
   <div class="right_inline"><textarea id="syrq" name="syrq"  disabled="disabled" class="form-control input-sm" rows="4" 

>${goods.syrq }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="不适宜人群[保健品,化妆品]">不适宜人群[保健品,化妆品]</nobr></div>
   <div class="right_inline"><textarea id="bsyrq" name="bsyrq" disabled="disabled" class="form-control input-sm" rows="4" 

>${goods.bsyrq }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="适合年龄[日用品]">适合年龄[日用品]</nobr></div>
   <div class="right_inline"><textarea id="shnl" name="shnl" disabled="disabled" class="form-control input-sm" rows="4" 

>${goods.shnl }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="注意事项[全]">注意事项[全]</nobr></div>
   <div class="right_inline"><textarea id="notes" name="notes" disabled="disabled"  class="form-control input-sm" rows="4" 

>${goods.notes }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="企业介绍[全]">企业介绍[全]</nobr></div>
   <div class="right_inline"><textarea id="introduction"  name="introduction" disabled="disabled" class="form-control input-sm" rows="4" 

>${goods.introduction }</textarea></div>
   </div>
     <div class="right_box_3">
   <div class="right_title2"><nobr title="使用方法[器械]">使用方法[器械]</nobr></div>
   <div class="right_inline"><textarea id="methodOfUse" name="methodOfUse"  disabled="disabled" class="form-control input-sm" rows="4" 

>${goods.methodOfUse }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="适用范围[器械,化妆品,日用品]">适用范围[器械,化妆品,日用品]</nobr></div>
   <div class="right_inline"><textarea id="scopeOfApplication" name="scopeOfApplication" disabled="disabled" class="form-control input-sm" rows="4" 

>${goods.scopeOfApplication }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="性能结构及组成[器械]">性能结构及组成[器械]</nobr></div>
   <div class="right_inline"><textarea id="xnjgjzc" name="xnjgjzc" disabled="disabled" class="form-control input-sm" rows="4" 

>${goods.xnjgjzc }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="临床试验[药品,器械]">临床试验[药品,器械]</nobr></div>
   <div class="right_inline"><textarea id="clinicalTrials" name="clinicalTrials" disabled="disabled" class="form-control input-sm" rows="4" 

>${goods.clinicalTrials }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="注册证[器械]">注册证[器械]</nobr></div>
   <div class="right_inline"><textarea id="registration" name="registration" disabled="disabled" class="form-control input-sm" rows="4" 

>${goods.registration }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="完整说明书文本(长文本]">完整说明书文本(长文本]</nobr></div>
   <div class="right_inline"><textarea id="allInstructions" name="allInstructions" disabled="disabled" class="form-control input-sm" rows="4"  
...
btn-sm" style="margin:5px 50px 0 0; width:100px;" onClick="addfl()">添加</button></div>
  ...
  <div class="right_input" style="width:300px;"><input id="smallUnits" name="smallUnits" disabled="disabled" value="${goods.smallUnits }"  type="text" 

class="form-control input-sm"  ></div>
  <div class="right_title textright">最小单位</div>

 <div class="right_input" style="width:300px;"><input id="smallesUnit" name="smallesUnit" disabled="disabled" value="${goods.smallesUnit }"   type="text" 
...
class="form-control input-sm"  ></div>
  ...
  <div class="right_input" style="width:300px;"><input id="tare" name="tare" disabled="disabled" value="${goods.tare }"  type="text" 

class="form-control input-sm"  ></div>
  <div class="right_title textright">小包数量</div>

 <div class="right_input" style="width:300px;"><input id="xbsl" name="xbsl" disabled="disabled"  value="${goods.xbsl }"  type="text" 
...
class="form-control input-sm"  ></div>
  ...
  <div class="right_input" style="width:300px;"><input id="packingSize" name="packingSize" disabled="disabled" value="${goods.packingSize }"  type="text" 

class="form-control input-sm" ></div>
  <div class="right_title textright">中包数量</div>

  <div class="right_input" style="width:300px;"><input id="zbsl" name="zbsl" value="${goods.zbsl }" disabled="disabled"  type="text" 
...
class="form-control input-sm"  ></div>
  ...
  <div class="right_input" style="width:300px;"><input id="netWeight" name="netWeight" disabled="disabled" value="${goods.netWeight }"  type="text" 

class="form-control input-sm"></div>
  <div class="right_title textright">大包数量</div>

 <div class="right_input" style="width:300px;"><input id="dbsl" name="dbsl" value="${goods.dbsl }" disabled="disabled" type="text" 
...
class="form-control input-sm"  ></div>
  ...
  <div class="right_input" style="width:300px;"><input id="costPrice" name="costPrice" disabled="disabled" data-bvalidator="decimal" value="${goods.costPrice }"  type="text" 

class="form-control input-sm" placeholder=" "></div>
  </div>
  <div class="right_inline">
  <div class="right_title">建议零售价</div>
  <div class="right_input" style="width:300px;"><input id="retailPrice" name="retailPrice" data-bvalidator="decimal" disabled="disabled" value="${goods.retailPrice }"  type="text" 

class="form-control input-sm" placeholder=" "></div>
  </div>
  <div class="right_inline">
  <div class="right_title">基本定价</div>
  <div class="right_input" style="width:300px;"><input id="basicPricing" name="basicPricing" disabled="disabled" data-bvalidator="decimal" value="${goods.basicPricing }"  type="text" 
...
style="width:100px;"><select id="salesStatus" name="goods.salesStatus" disabled="disabled" class="form-control input-sm">
  ...
  <div class="right_input" style="width:300px;"><input  type="text" 
   ...
   class="form-control input-sm" disabled="disabled" placeholder=" "></div>
  </div>
  <div class="right_inline">
  <div class="right_title" style="line-height:60px;">生成套餐</div>
<div class="right_title"  style="width:100px"><label class="checkbox-inline" >
  <input type="checkbox" disabled="disabled" id="inlineCheckbox1" value="option1" style="margin-
