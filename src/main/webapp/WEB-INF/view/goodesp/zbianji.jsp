 ...
 <script type="text/javascript">
    $(document).ready(function(){
	   ...
	   // $("#filepath").click(function(){
	    	//var imgPath = $("#filepath").attr('src') + '?' + new Date().getTime();//第一张图片
	    	//读取img的宽、高
			//var width = $("#filepath").attr("width");
			//var height = $("#filepath").attr("height");
			//var proportion = width + ":" + height;
			//var filepatha = $("#filepatha").attr('src') + '?' + new Date().getTime();//第二张图片
			//var filepathb = $("#filepathb").attr('src') + '?' + new Date().getTime();//第三张图片
			//var filepathc = $("#filepathc").attr('src') + '?' + new Date().getTime();//第四张图片
			//var filepathd = $("#filepathd").attr('src') + '?' + new Date().getTime();//第五张图片
			//var filepathe = $("#filepathe").attr('src') + '?' + new Date().getTime();//第六张图片
			//window.location.href="<%=request.getContextPath() %>/imageScissorAction.do?path="+imgPath+"&proportion="+proportion+"&filepatha="+filepatha+"&filepathb="+filepathb+"&filepathc="+filepathc+"&filepathd="+filepathd+"&filepathe="+filepathe+"&staus="+1;   
	   // });
	  //设置图片的双击事件处理 第二张图片
	   // $("#filepatha").click(function(){
	    	//var filepatha = $("#filepatha").attr('src') + '?' + new Date().getTime();//第二张图片
	    	//读取img的宽、高
			//var width = $("#filepatha").attr("width");
			//var height = $("#filepatha").attr("height");
			//var proportion = width + ":" + height;
			//var imgPath=$("#filepath").attr('src') + '?' + new Date().getTime();//第一张图片
			//var filepathb = $("#filepathb").attr('src') + '?' + new Date().getTime();//第三张图片
			//var filepathc = $("#filepathc").attr('src') + '?' + new Date().getTime();//第四张图片
			//var filepathd = $("#filepathd").attr('src') + '?' + new Date().getTime();//第五张图片
			//var filepathe = $("#filepathe").attr('src') + '?' + new Date().getTime();//第六张图片
			//window.location.href="<%=request.getContextPath() %>/imageScissorAction.do?filepatha="+filepatha+"&proportion="+proportion+"&path="+imgPath+"&filepathb="+filepathb+"&filepathc="+filepathc+"&filepathd="+filepathd+"&filepathe="+filepathe+"&staus="+2;   
	   // });
	  //设置图片的双击事件处理 第三张图片
	    //$("#filepathb").click(function(){
	    	//var filepathb = $("#filepathb").attr('src') + '?' + new Date().getTime();//第三张图片
	    	//读取img的宽、高
			//var width = $("#filepathb").attr("width");
			//var height = $("#filepathb").attr("height");
			//var proportion = width + ":" + height;
			//var imgPath=$("#filepath").attr('src') + '?' + new Date().getTime();//第一张图片
			//var filepatha = $("#filepatha").attr('src') + '?' + new Date().getTime();//第二张图片
			//var filepathc = $("#filepathc").attr('src') + '?' + new Date().getTime();//第四张图片
			//var filepathd = $("#filepathd").attr('src') + '?' + new Date().getTime();//第五张图片
			//var filepathe = $("#filepathe").attr('src') + '?' + new Date().getTime();//第六张图片
			//window.location.href="<%=request.getContextPath() %>/imageScissorAction.do?filepathb="+filepathb+"&proportion="+proportion+"&path="+imgPath+"&filepatha="+filepatha+"&filepathc="+filepathc+"&filepathd="+filepathd+"&filepathe="+filepathe+"&staus="+3;   
	    });
	  //设置图片的双击事件处理 第四张图片
	    //$("#filepathc").click(function(){
	    	//var filepathc = $("#filepathc").attr('src') + '?' + new Date().getTime();//第四张图片
	    	//读取img的宽、高
			//var width = $("#filepathc").attr("width");
			//var height= $("#filepathc").attr("height");
			//var proportion = width + ":" + height;
			//var imgPath=$("#filepath").attr('src') + '?' + new Date().getTime();//第一张图片
			//var filepatha = $("#filepatha").attr('src') + '?' + new Date().getTime();//第二张图片
			//var filepathb = $("#filepathb").attr('src') + '?' + new Date().getTime();//第三张图片
			//var filepathd = $("#filepathd").attr('src') + '?' + new Date().getTime();//第五张图片
			//var filepathe = $("#filepathe").attr('src') + '?' + new Date().getTime();//第六张图片
			//window.location.href="<%=request.getContextPath() %>/imageScissorAction.do?filepathc="+filepathc+"&proportion="+proportion+"&path="+imgPath+"&filepatha="+filepatha+"&filepathb="+filepathb+"&filepathd="+filepathd+"&filepathe="+filepathe+"&staus="+4;   
	   // });
	  
	    //设置图片的双击事件处理 第五张图片
	    //$("#filepathd").click(function(){
	    //	var filepathd = $("#filepathd").attr('src') + '?' + new Date().getTime();//第五张图片
	    	//读取img的宽、高
		//	var width = $("#filepathd").attr("width");
		//	var height= $("#filepathcd").attr("height");
			//var proportion = width + ":" + height;
			//var imgPath=$("#filepath").attr('src') + '?' + new Date().getTime();//第一张图片
			//var filepatha = $("#filepatha").attr('src') + '?' + new Date().getTime();//第二张图片
			//var filepathb = $("#filepathb").attr('src') + '?' + new Date().getTime();//第三张图片
			//var filepathc = $("#filepathc").attr('src') + '?' + new Date().getTime();//第四张图片
			//var filepathe = $("#filepathe").attr('src') + '?' + new Date().getTime();//第六张图片
			//window.location.href="<%=request.getContextPath() %>/imageScissorAction.do?filepathd="+filepathd+"&proportion="+proportion+"&path="+imgPath+"&filepatha="+filepatha+"&filepathb="+filepathb+"filepathc="+filepathc+"&filepathe="+filepathe+"&staus="+5;   
	   // });
	    //设置图片的双击事件处理 第六张图片
	   // $("#filepathe").click(function(){
	    	//var filepathe = $("#filepathe").attr('src') + '?' + new Date().getTime();//第六张图片
	    	//读取img的宽、高
			//var width = $("#filepathc").attr("width");
			//var height= $("#filepathc").attr("height");
			...
			//var filepathc = $("#filepathc").attr('src') + '?' + new Date().getTime();//第四张图片
			//var filepathd = $("#filepathd").attr('src') + '?' + new Date().getTime();//第五张图片
			//window.location.href="<%=request.getContextPath() %>/imageScissorAction.do?filepathe="+filepathe+"&proportion="+proportion+"&path="+imgPath+"&filepatha="+filepatha+"&filepathb="+filepathb+"&filepathc="+filepathc+"&filepathd="+filepathd+"&staus="+6;   
	    //});
   // });
...
function add(){
	...
	if(confirm('你确定要提交吗？')){
	 document.form.action = "goodsp.do?method=goodsSave&ids="+ids;
	 document.form.submit();
	 }else{
         return false;
     }
...
<div class="right_h"><h3> 商品编辑模板</h3></div>
  <div class="right_inline"><span style="float:right"><a href="#">查看对应套餐
	...
	<div class="right_input" style="width:100px;"><select name="goodsType" id="goodsType" class="form-control 

input-sm">
  <option value="0" ${goods.goodsType eq '0'? 'selected=selected':'' }>不限</option>
  <option value="1" ${goods.goodsType eq '1'? 'selected=selected':'' }>药品</option>
  <option value="2" ${goods.goodsType eq '2'? 'selected=selected':'' }>器械</option>
  <option value="3" ${goods.goodsType eq '3'? 'selected=selected':'' }>食品保健</option>
  <option value="4" ${goods.goodsType eq '4'? 'selected=selected':'' }>化妆品</option>
</select></div>
</div>
 ...
 <div class="right_box2"><div class="right_box_l">
  ...
  <div class="right_input" style="width:300px;"><input name="interiorId" id="interiorId" value="${goods.interiorId }" type="text" class="form-control input-sm"  placeholder=" "></div>
  </div>
  <div class="right_inline">
  <div class="right_title">内部编码</div>
  <div class="right_input" style="width:300px;"><input name="interiorCode" id="interiorCode" value="${goods.interiorCode }" type="text" class="form-control input-sm" placeholder=" "></div>
  </div>
  <div class="right_inline">
  <div class="right_title">条形码</div>
  <div class="right_input" style="width:300px;"><input name="barCode" id="barCode" value="${goods.barCode }" type="text" class="form-control input-sm"  placeholder=" "></div>
  </div>
  <div class="right_inline">
  <div class="right_title">通用名</div>
  <div class="right_input" style="width:300px;"><input name="commonName" id="commonName" value="${goods.commonName }" type="text" class="form-control input-sm"  placeholder="普通商品的商品名"></div>
  </div>
  <div class="right_inline">
  <div class="right_title">商品名</div>
  <div class="right_input" style="width:300px;"><input name="goodsName" id="goodsName" value="${goods.goodsName }" type="text" class="form-control input-sm"  placeholder=" "></div>
  </div>
  <div class="right_inline">
  <div class="right_title">英文或拼音</div>
  <div class="right_input" style="width:300px;"><input name="englishOrPinyin" id="englishOrPinyin" value="${goods.englishOrPinyin }" type="text" class="form-control input-sm"  placeholder=" "></div>
  </div>
  <div class="right_inline">
  <div class="right_title">拼音编码</div>
  <div class="right_input" style="width:300px;"><input name="pinyinCode" id="pinyinCode" value="${goods.pinyinCode }" type="text" class="form-control input-sm"  placeholder=" "></div>
  </div>
  </div>
...
<select name="qsanj" id="qsanj" onChange="qsanji()" class="form-control input-sm" >
  ...
  <div class="right_input" style="width:500px;"><input name="keyWord" id="keyWord" value="${goods.keyWord }" type="text" class="form-control input-sm"  placeholder=" "></div>
  </div>
  <div class="right_inline">
  <div class="right_title">规格型号</div>
  
  <div class="right_input" style="width:300px;"><input name="specifications" id="specifications" value="${goods.specifications }" type="text" class="form-control input-sm"  placeholder="纸铝复合膜包装；6包/盒、8包/盒、10包/盒

、12包/盒、14包/盒、20包/盒。 "></div>
  <div class="right_title textright">品牌</div>

 <div class="right_input" style="width:300px;"><input name="brand" id="brand" value="${goods.brand }" type="text" 
...
class="form-control input-sm"  placeholder=" 江中"></div>
  ...
  <div class="right_input" style="width:300px;"><input name="manufacturer" id="manufacturer" value="${goods.manufacturer }" type="text" 
...
、12包/盒、14包/盒、20包/盒。 "></div>
 ...
 <div class="right_input" style="width:300px;"><input name="productionAddress" id="productionAddress" value="${goods.productionAddress }" type="text" 
...
class="form-control input-sm"  placeholder=" 江中"></div>
  ...
  <div class="right_box2">  <div class="right_box_l">
		...
		<div class="right_inline"><textarea name="brief"  id="brief" value="${goods.brief }" rows="4" 
...
class="form-control input-sm" style="width:360px;"></textarea></div>
  ...
  <div class="right_box_l">
		...
		<div class="right_inline"><textarea name="goodsDetails" id="goodsDetails" value="${goods.goodsDetails }" class="form-control input-sm" 
...
rows="4" style="width:360px;"></textarea></div>
  ...
  <div class="right_box_l">
        ...
        <div class="right_inline"><span class="pull-right" style="padding-right:35px" data-toggle="modal" data-target="#xxjs">预览</span>详细介绍（html）</div>
...
江西副省长姚木根或涉水</div>
		...
		<div class="right_inline"><textarea name="goodsDetailsHtml" id="goodsDetailsHtml" value="${goods.goodsDetailsHtml }" class="form-control input-sm" 
...
rows="4" style="width:360px;"></textarea></div>
  ...
  <div class="right_box_l">
        ...
        <div class="right_inline"><span class="pull-right" style="padding-right:35px" data-toggle="modal" data-target="#yulan">预览</span>图文介绍（html）</div>
...
江西副省长姚木根或涉水</div>
		...
		<div class="right_inline"><textarea name="picTextDetailsHtml" id="picTextDetailsHtml" value="${goods.picTextDetailsHtml }" class="form-control input-sm" 
...
<div id="productPanel" class="right_box2" >
   <div class="right_inline">
  <div class="right_title">药监分类一级</div>
...
style="width:150px;">
    <input name="approvalDocument" id="approvalDocument" value="${goods.approvalDocument }" type="text" class="form-control"  placeholder=" ">
  </span></div>
  <div class="right_title_min">执行标准</div>
  <div class="right_input" style="width:150px;"><input id="standard" value="${goods.standard }" name="standard" type="text" 

class="form-control input-sm"  placeholder=" "></div>
  <div class="right_title_min">卫生许可证号</div>
  <div class="right_input" style="width:150px;"><input id="hygieneLicense" value="${goods.hygieneLicense }" name="hygieneLicense" type="text" 
...
class="form-control input-sm"  placeholder=" "></div>
  ...
  <input type="checkbox"  checked="checked" name="gmp"  id="gmp" value="${goods.gmp }">
  </c:if>
   <c:if test="${empty goods.gmp }">
  <input type="checkbox"  name="gmp"  id="gmp" value="">
  </c:if>
   GMP已认证
</label>
   </div>
  ...
  <div class="right_input" style="width:190px;">
    <input name="valid" id="valid" value="${goods.valid }" type="text" class="form-control input-sm"  placeholder=" 

">
  </div>
  <div class="right_title_min">存储条件</div>
  <div class="right_input" style="width:190px;">
    <input name="storage" id="storage" value="${goods.storage }" type="text" class="form-control input-sm"  placeholder=" 
...
">
  ...
  <div class="right_inline">
   ...
   <div class="right_inline"><textarea id="ingredients" name="ingredients"  class="form-control input-sm" rows="4" 
...
>${goods.ingredients }</textarea></div>
   ...
   <div class="right_inline"><textarea id="tcac" name="tcac" class="form-control input-sm" rows="4" 
...
> ${goods.tcac }</textarea></div>
   ...
   <div class="right_inline"><textarea id="indication" name="indication" class="form-control input-sm" rows="4" 
>${goods.indication }</textarea></div>
   </div>
   
   <div class="right_box_3">
   <div class="right_title2"><nobr title="用法用量[药品,食品保健品,化妆品,日用品]">用法用量[药品,食品保健品,化妆品,日用品]</nobr></div>
   <div class="right_inline"><textarea id="usageAndDosage" name="usageAndDosage" class="form-control input-sm" rows="4" 

>${goods.usageAndDosage }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="不良反应[药品,器械,日用品]">不良反应[药品,器械,日用品]</nobr></div>
   <div class="right_inline"><textarea id="adverseDrugReactions" name="adverseDrugReactions" class="form-control input-sm" rows="4" 
...
>${goods.adverseDrugReactions }</textarea></div>
   ...
   <div class="right_inline"><textarea id="taboo" name="taboo" class="form-control input-sm" rows="4" 

>${goods.taboo }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="功能主治[药品]">功能主治[药品]</nobr></div>
   <div class="right_inline"><textarea id="treatment" name="treatment" class="form-control input-sm" rows="4" 

>${goods.treatment }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="药理作用[药品]">药理作用[药品]</nobr></div>
   <div class="right_inline"><textarea id="pharmacological" name="pharmacological" class="form-control input-sm" rows="4" 

>${goods.pharmacological }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="药物相互作用[药品]">药物相互作用[药品]</nobr></div>
   <div class="right_inline"><textarea id="interactions" name="interactions" class="form-control input-sm" rows="4" 

>${goods.interactions }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="药代动力学[药品]">药代动力学[药品]</nobr></div>
   <div class="right_inline"><textarea id="pharmacokinetics" name="pharmacokinetics" class="form-control input-sm" rows="4" 

>${goods.pharmacokinetics }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="特殊人群用药[药品]">特殊人群用药[药品]</nobr></div>
   <div class="right_inline"><textarea id="tsrqyy" name="tsrqyy" class="form-control input-sm" rows="4" 

>${goods.tsrqyy }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="药物过量[药品]">药物过量[药品]</nobr></div>
   <div class="right_inline"><textarea id="overdose" name="overdose" class="form-control input-sm" rows="4" 

>${goods.overdose }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="性味归经[中药]">性味归经[中药]</nobr></div>
   <div class="right_inline"><textarea id="xwgj" name="xwgj" class="form-control input-sm" rows="4" 

>${goods.xwgj }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="药理毒理[药品]">药理毒理[药品]</nobr></div>
   <div class="right_inline"><textarea id="yldl" name="yldl" class="form-control input-sm" rows="4" 

>${goods.yldl }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="说明书核准日期[药品,食品保健品,化妆品]">说明书核准日期[药品,食品保健品,化妆品]</nobr></div>
   <div class="right_inline"><textarea id="smshzrq" name="smshzrq" class="form-control input-sm" rows="4" 

>${goods.smshzrq }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="作用类别[药品,日用品,化妆品]">作用类别[药品,日用品,化妆品]</nobr></div>
   <div class="right_inline"><textarea id="categories" name="categories" class="form-control input-sm" rows="4" 

>${goods.categories }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="作用用途[化妆品,日用品] 保健作用[保健品]">作用用途[化妆品,日用品] 保健作用[保健品]</nobr></div>
   <div class="right_inline"><textarea id="purpose"  name="purpose" class="form-control input-sm" rows="4" 

>${goods.purpose }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="生产许可证号[化妆品]">生产许可证号[化妆品]</nobr></div>
   <div class="right_inline"><textarea id="license" name="license" class="form-control input-sm" rows="4" 

>${goods.license }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="适宜人群[器械,食品保健品,化妆品,日用品]">适宜人群[器械,食品保健品,化妆品,日用品]</nobr></div>
   <div class="right_inline"><textarea id="syrq" name="syrq" class="form-control input-sm" rows="4" 

>${goods.syrq }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="不适宜人群[保健品,化妆品]">不适宜人群[保健品,化妆品]</nobr></div>
   <div class="right_inline"><textarea id="bsyrq" name="bsyrq" class="form-control input-sm" rows="4" 

>${goods.bsyrq }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="适合年龄[日用品]">适合年龄[日用品]</nobr></div>
   <div class="right_inline"><textarea id="shnl" name="shnl" class="form-control input-sm" rows="4" 

>${goods.shnl }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="注意事项[全]">注意事项[全]</nobr></div>
   <div class="right_inline"><textarea id="notes" name="notes"  class="form-control input-sm" rows="4" 

>${goods.notes }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="企业介绍[全]">企业介绍[全]</nobr></div>
   <div class="right_inline"><textarea id="introduction"  name="introduction" class="form-control input-sm" rows="4" 

>${goods.introduction }</textarea></div>
   </div>
     <div class="right_box_3">
   <div class="right_title2"><nobr title="使用方法[器械]">使用方法[器械]</nobr></div>
   <div class="right_inline"><textarea id="methodOfUse" name="methodOfUse"  class="form-control input-sm" rows="4" 

>${goods.methodOfUse }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="适用范围[器械,化妆品,日用品]">适用范围[器械,化妆品,日用品]</nobr></div>
   <div class="right_inline"><textarea id="scopeOfApplication" name="scopeOfApplication" class="form-control input-sm" rows="4" 

>${goods.scopeOfApplication }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="性能结构及组成[器械]">性能结构及组成[器械]</nobr></div>
   <div class="right_inline"><textarea id="xnjgjzc" name="xnjgjzc" class="form-control input-sm" rows="4" 

>${goods.xnjgjzc }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="临床试验[药品,器械]">临床试验[药品,器械]</nobr></div>
   <div class="right_inline"><textarea id="clinicalTrials" name="clinicalTrials" class="form-control input-sm" rows="4" 

>${goods.clinicalTrials }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="注册证[器械]">注册证[器械]</nobr></div>
   <div class="right_inline"><textarea id="registration" name="registration" class="form-control input-sm" rows="4" 

>${goods.registration }</textarea></div>
   </div>
   <div class="right_box_3">
   <div class="right_title2"><nobr title="完整说明书文本(长文本]">完整说明书文本(长文本]</nobr></div>
   <div class="right_inline"><textarea id="allInstructions" name="allInstructions" class="form-control input-sm" rows="4"  
...
btn-sm" style="margin:5px 50px 0 0; width:100px;" onClick="addfl()">添加</button></div>
  ...
  <div class="right_input" style="width:300px;"><input id="smallUnits" name="smallUnits" value="${goods.smallUnits }"  type="text" 

class="form-control input-sm"  ></div>
  <div class="right_title textright">最小单位</div>

 <div class="right_input" style="width:300px;"><input id="smallesUnit" name="smallesUnit" value="${goods.smallesUnit }"   type="text" 
...
class="form-control input-sm"  ></div>
  ...
  <div class="right_input" style="width:300px;"><input id="tare" name="tare" value="${goods.tare }"  type="text" 

class="form-control input-sm"  ></div>
  <div class="right_title textright">小包数量</div>

 <div class="right_input" style="width:300px;"><input id="xbsl" name="xbsl"  value="${goods.xbsl }"  type="text" 
...
class="form-control input-sm"  ></div>
  ...
  <div class="right_input" style="width:300px;"><input id="packingSize" name="packingSize" value="${goods.packingSize }"  type="text" 

class="form-control input-sm" ></div>
  <div class="right_title textright">中包数量</div>

  <div class="right_input" style="width:300px;"><input id="zbsl" name="zbsl" value="${goods.zbsl }"  type="text" 
...
class="form-control input-sm"  ></div>
  ...
  <div class="right_input" style="width:300px;"><input id="netWeight" name="netWeight" value="${goods.netWeight }"  type="text" 

class="form-control input-sm"></div>
  <div class="right_title textright">大包数量</div>

 <div class="right_input" style="width:300px;"><input id="dbsl" name="dbsl" value="${goods.dbsl }" type="text" 
...
class="form-control input-sm"  ></div>
  ...
  <div class="right_input" style="width:300px;"><input id="costPrice" name="costPrice" value="${goods.costPrice }"  type="text" 

class="form-control input-sm" placeholder=" "></div>
  </div>
  <div class="right_inline">
  <div class="right_title">建议零售价</div>
  <div class="right_input" style="width:300px;"><input id="retailPrice" name="retailPrice" value="${goods.retailPrice }"  type="text" 

class="form-control input-sm" placeholder=" "></div>
  </div>
  <div class="right_inline">
  <div class="right_title">基本定价</div>
  <div class="right_input" style="width:300px;"><input id="basicPricing" name="basicPricing" value="${goods.basicPricing }"  type="text" 
