...
function totupian(){
	  ...
	  jQuery.ligerDialog.open({ 
		...
		slide:true,
		title:'图片设置', 
		url: '<%=request.getContextPath()%>/goodsImage.do?method=load&id='+id+'&wtype=6' 
		
	}); 
}
//主商品对应的套餐	
function zhushangpitaocan() {
var id=document.getElementById("id").value;
	...
	jQuery.ligerDialog.open({ 
		...
		slide:true,
		title:'主商品对应的套餐', 
		url: '<%=request.getContextPath()%>/goodsp.do?method=mainGoodsSetMeal&id='+id 
		
	}); 
}
//非主商品对应的套餐	
function nonzhushangpitaocan() {
var id=document.getElementById("id").value;
	...
	jQuery.ligerDialog.open({ 
		...
		slide:true,
		title:'非主商品对应的套餐', 
		url: '<%=request.getContextPath()%>/goodsp.do?method=nonMainGoodsSetMeal&id='+id 
...
var id=document.getElementById("id").value;
	...
	jQuery.ligerDialog.open({ 
		...
		slide:true,
		title:'主商品对应的套餐副本', 
		url: '<%=request.getContextPath()%>/goodsp.do?method=mainGroupGoodsCopyList&id='+id 
		
	}); 
}
//非主商品对应的套餐	
function nonMainGoodstcfb() {
var id=document.getElementById("id").value;
	...
	jQuery.ligerDialog.open({ 
		...
		slide:true,
		title:'非主商品对应的套餐副本', 
		url: '<%=request.getContextPath()%>/goodsp.do?method=nonMainGroupGoodsCopyList&id='+id 
...
<input type="hidden" id="createTime" name="createTime" value="${goods.createTime}"/>
 <input type="hidden" id="patha" name="patha" value="${patha}"/>
 <input type="hidden" id="zjradio" name="zjradio" value="${zjradio}"/>
 <input type="hidden" id="qdradio" name="qdradio" value="${qdradio}"/>
    <input type="hidden" id="proportion" name="proportion" value=""/>
    <input type="hidden" id="bpath" name="bpath" value="${bpath}" />
    <input type="hidden" id="bpath1" name="bpath1" value="${bpath1}" />
    <input type="hidden" id="bpath2" name="bpath2" value="${bpath2}" />
    <input type="hidden" id="bpath3" name="bpath3" value="${bpath3}" />
    <input type="hidden" id="bpath4" name="bpath4" value="${bpath4}" />
    <input type="hidden" id="bpath5" name="bpath5" value="${bpath5}" />
    
    <input type="hidden" id="fxingyi" name="fxingyi" value="${fxingyi}" />
    <input type="hidden" id="fxinger" name="fxinger" value="${fxinger}" />
    <input type="hidden" id="fxingsan" name="fxingsan" value="${fxingsan}" />
    
    <input type="hidden" id="yxingyi" name="yxingyi" value="${yxingyi}" />
    <input type="hidden" id="yxinger" name="yxinger" value="${yxinger}" />
    <input type="hidden" id="yxingsan" name="yxingsan" value="${yxingsan}" />
    ...
    <input type="hidden" id="seacheditStatus" name="seacheditStatus" value="${seacheditStatus}" />
...
<div class="right_box">
<div class="right_h"><h3> 商品编辑</h3></div>
  <div class="right_inline">
  <span style="float:right"><a href="javascript:void(0)" onclick="zhushangpitaocan()">查看此商品为主商品对应套餐</a></span>
  <br>
  <span style="float:right"><a href="javascript:void(0)" onclick="nonzhushangpitaocan()">查看此商品为非主商品对应套餐</a></span>
  <br>
  <span style="float:right"><a href="javascript:void(0)" onclick="mainGoodstcfb()">查看此商品为主商品对应套餐副本</a></span>
  <br>
  <span style="float:right"><a href="javascript:void(0)" onclick="nonMainGoodstcfb()">查看此商品为非主商品对应套餐副本</a></span>
  <br>
 ...
 <div class="right_box2"><div class="right_box_l">
  ...
  <div class="right_input" style="width:300px;"><input name="interiorId" id="interiorId" data-bvalidator="maxlength[200]" value="${goods.interiorId }" type="text" class="form-control input-sm"  placeholder=" "></div>
  </div>
  <div class="right_inline">
  <div class="right_title">内部编码</div>
  <div class="right_input" style="width:300px;">
  <input name="interiorCode" id="interiorCode" data-bvalidator="maxlength[200],required" value="${goods.interiorCode }" onchange="onlangj()" type="text" class="form-control input-sm" placeholder=" ">
  <input type="hidden" id="oldinteriorCode" name="oldinteriorCode" value="${oldinteriorCode}"/>
  </div>
  </div>
  <div class="right_inline">
  <div class="right_title">条形码</div>
  <div class="right_input" style="width:300px;"><input name="barCode" id="barCode" data-bvalidator="maxlength[200]" value="${goods.barCode }" type="text" class="form-control input-sm"  placeholder=" "></div>
  </div>
  <div class="right_inline">
  <div class="right_title">通用名</div>
  <div class="right_input" style="width:300px;"><input name="commonName" id="commonName" data-bvalidator="maxlength[200]" value="${goods.commonName }" type="text" class="form-control input-sm"  placeholder="普通商品的商品名"></div>
  </div>
  <div class="right_inline">
  <div class="right_title">商品名</div>
  <div class="right_input" style="width:300px;"><input name="goodsName" id="goodsName" data-bvalidator="maxlength[200],required" value="${goods.goodsName }" type="text" class="form-control input-sm"  placeholder=" "></div>
  </div>
  <div class="right_inline">
  <div class="right_title">英文或拼音</div>
  <div class="right_input" style="width:300px;"><input name="englishOrPinyin" id="englishOrPinyin" data-bvalidator="maxlength[200]" value="${goods.englishOrPinyin }" type="text" class="form-control input-sm"  placeholder=" "></div>
  </div>
  <div class="right_inline">
  <div class="right_title">拼音编码</div>
  <div class="right_input" style="width:300px;"><input name="pinyinCode" id="pinyinCode" data-bvalidator="maxlength[200]" value="${goods.pinyinCode }" type="text" class="form-control input-sm"  placeholder=" "></div>
  </div>
  </div>
 ...
 <span style="float:right; margin:40px 120px 0 0"><button type="button" onclick="totupian()" class="btn btn-info btn-sm pull-right" >编辑图片</button></span>
 </div>
...
<select name="qsanj" id="qsanj" onChange="qsanji()" class="form-control input-sm" >
  ...
  <div class="right_input" style="width:500px;"><input name="keyWord" id="keyWord" data-bvalidator="maxlength[200]" value="${goods.keyWord }" type="text" class="form-control input-sm"  placeholder=" "></div>
  </div>
  <div class="right_inline">
  <div class="right_title">规格型号</div>
  
  <div class="right_input" style="width:300px;"><input name="specifications" id="specifications" data-bvalidator="maxlength[200]" value="${goods.specifications }" type="text" class="form-control input-sm"  placeholder=""></div>
  <div class="right_title textright">品牌</div>

 <div class="right_input" style="width:300px;"><input name="brand" id="brand" data-bvalidator="maxlength[200]"  value="${goods.brand }" type="text" 
...
class="form-control input-sm"  placeholder=" 江中"></div>
  ...
  <div class="right_input" style="width:300px;"><input name="manufacturer" id="manufacturer" data-bvalidator="maxlength[200]" value="${goods.manufacturer }" type="text" 

class="form-control input-sm"  placeholder=" "></div>
  <div class="right_title textright">生产地址</div>

 <div class="right_input" style="width:300px;"><input name="productionAddress" id="productionAddress" data-bvalidator="maxlength[200]" value="${goods.productionAddress }" type="text" 
...
style="width:150px;">
    <input name="approvalDocument" id="approvalDocument" data-bvalidator="maxlength[200]" value="${goods.approvalDocument }" type="text" class="form-control"  placeholder=" ">
  </span></div>
  <div class="right_title_min">执行标准</div>
  <div class="right_input" style="width:150px;"><input id="standard" data-bvalidator="maxlength[200]" value="${goods.standard }" name="standard" type="text" 

class="form-control input-sm"  placeholder=" "></div>
  <div class="right_title_min">卫生许可证号</div>
  <div class="right_input" style="width:150px;"><input id="hygieneLicense"  data-bvalidator="maxlength[200]" value="${goods.hygieneLicense }" name="hygieneLicense" type="text" 
...
class="form-control input-sm"  placeholder=" "></div>
  ...
  <div class="right_input"  style="width:120px;">
    <select name="sfHanma" id="sfHanma" class="form-control input-sm" >
  ...
  <div class="right_input"  style="width:120px;">
    <select name="sfDatai" id="sfDatai" class="form-control input-sm" >
  ...
  <div class="right_input" style="width:190px;">
    <input name="valid" id="valid" data-bvalidator="maxlength[200]" value="${goods.valid }" type="text" class="form-control input-sm"  placeholder=" 

">
  </div>
  <div class="right_title_min">存储条件</div>
  <div class="right_input" style="width:190px;">
    <input name="storage" id="storage" data-bvalidator="maxlength[200]" value="${goods.storage }" type="text" class="form-control input-sm"  placeholder=" 
...
btn-sm" style="margin:5px 50px 0 0; width:100px;" onClick="addfl()">添加</button></div>
  ...
  <div class="right_input" style="width:300px;"><input id="smallUnits" name="smallUnits" data-bvalidator="maxlength[200]" value="${goods.smallUnits }"  type="text" 

class="form-control input-sm"  ></div>
  <div class="right_title textright">最小单位</div>

 <div class="right_input" style="width:300px;"><input id="smallesUnit" name="smallesUnit" data-bvalidator="maxlength[200]" value="${goods.smallesUnit }"   type="text" 
...
class="form-control input-sm"  ></div>
  ...
  <div class="right_input" style="width:300px;"><input id="tare" name="tare" data-bvalidator="maxlength[200]" value="${goods.tare }"  type="text" 

class="form-control input-sm"  ></div>
  <div class="right_title textright">小包数量</div>

 <div class="right_input" style="width:300px;"><input id="xbsl" name="xbsl" data-bvalidator="maxlength[200]"  value="${goods.xbsl }"  type="text" 
...
class="form-control input-sm"  ></div>
  ...
  <div class="right_input" style="width:300px;"><input id="packingSize" name="packingSize" data-bvalidator="maxlength[200]" value="${goods.packingSize }"  type="text" 

class="form-control input-sm" ></div>
  <div class="right_title textright">中包数量</div>

  <div class="right_input" style="width:300px;"><input id="zbsl" name="zbsl" data-bvalidator="maxlength[200]" value="${goods.zbsl }"  type="text" 
...
class="form-control input-sm"  ></div>
  ...
  <div class="right_input" style="width:300px;"><input id="netWeight" name="netWeight" data-bvalidator="maxlength[200]" value="${goods.netWeight }"  type="text" 

class="form-control input-sm"></div>
  <div class="right_title textright">大包数量</div>

 <div class="right_input" style="width:300px;"><input id="dbsl" name="dbsl" data-bvalidator="maxlength[200]" value="${goods.dbsl }" type="text" 
...
class="form-control input-sm"  ></div>
  ...
  <div class="right_input" style="width:300px;"><input id="costPrice" name="costPrice" data-bvalidator="number" value="${goods.costPrice }"  type="text" 

class="form-control input-sm" placeholder=" "></div>
  </div>
  <div class="right_inline">
  <div class="right_title">建议零售价</div>
  <div class="right_input" style="width:300px;"><input id="retailPrice" name="retailPrice" data-bvalidator="number" value="${goods.retailPrice }"  type="text" 

class="form-control input-sm" placeholder=" "></div>
  </div>
  <div class="right_inline">
  <div class="right_title">基本定价</div>
  <div class="right_input" style="width:300px;"><input id="basicPricing" name="basicPricing" data-bvalidator="number" value="${goods.basicPricing }"  type="text" 
...
style="width:100px;"><select id="salesStatus" name="goods.salesStatus" class="form-control input-sm">
  ...
  <div class="right_input" style="width:300px;"><input  type="text" id="repertoryCount" data-bvalidator="digit" name="repertoryCount" value="${goods.repertoryCount }"
