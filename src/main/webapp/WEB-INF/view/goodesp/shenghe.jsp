	  ...
	  $("#btnSubmit").click(function(){
			...
			if(val==null){
				...
				var notPassCause=document.getElementById("notPassCause").value;
				 ...
				 document.form.action = "goodsp.do?method=shenghadd&val="+val+"&notPassCause="+notPassCause;
...
function back(){
	 document.form.action = "goodsp.do?method=shengback";
	 document.form.submit();
}
...
<div class="right_box">
<div class="right_h"><h3>商品美编审核</h3></div>
  
    <div class="right_title">商品类型 </div>
	<div class="right_input" style="width:100px;">
<select name="goodsType" id="goodsType" class="form-control input-sm" disabled="disabled">
...
class="form-control input-sm"  placeholder=" "></div>
  ...
  <div class="right_input"  style="width:120px;">
    <select name="prescriptionType" id="prescriptionType"  class="form-control input-sm" disabled="disabled">
...
<div id="keywordPanel" class="select-box"></div>
  ...
  <div class="right_inline"><button disabled="disabled" type="button" class="btn btn-info pull-right  
...
<div class="row">
  <div class="col-md-12" style="vertical-align: bottom;">
  	<div class="radio-inline" style="margin-top: 2%;">
  		<input type="radio" id="optionsRadios" name="optionsRadios" value="0"> <span>通过审核</span>
  	</div>
  	<div class="radio-inline" style="margin-top: 2%;">
  		<input type="radio" id="optionsRadios" name="optionsRadios" value="2"><span>未通过审核</span>
  	</div>
  	<div class="radio-inline">
  		<textarea id="notPassCause" name="notPassCause" class="form-control input-sm" rows="3" style="width: 300px;resize: none;" data-bvalidator="maxlength[200]" placeholder="未通过原因 ..."></textarea>
  	</div>
  	<div class="radio-inline" style="margin-top: 2%;">
		<button type="button" id="btnSubmit" class="btn btn-info pull-right  btn-sm" >保存</button>
  	</div>
  	<div class="radio-inline" style="margin-top: 2%;">
		<button type="button" onClick="back()" class="btn btn-info pull-right  btn-sm" style="margin-left: 50%px;">返回</button>
  	</div>

  	<div class="radio-inline" style="margin-top: 2%;">
  		<button type="button" class="btn btn-info btn-sm" id="showLog">日志列表</button>
  	</div>
  </div>
  ...
  <div class="right_inline">
	...
	<div class="right_inline">
	<!-- 
	<button type="button" class="btn btn-info btn-sm" style="margin:5px 15px 0 0;" id="showLog">日志列表</button></div>
	 -->
...
class="table table-striped table-bordered table-hover">
        <tr>
          <td width="23%" align="center">时间</td>
          <td width="28%" align="center">操作者</td>
          <td width="49%" align="center">行为</td>
        </tr>
	...
	<!--日志收起-->
				...
				<!-- <div class="right_box2">
					<div class="right_box_l pull-right">
						<div class="right_inline" style="padding-left: 30px;">
							<div class="right_title" style="width: 80px">
								<label class="radio-inline"> <input type="radio"
									id="optionsRadios" name="optionsRadios" value="0"
									style="margin-top: 9px;"> 通过审核
								</label>
							</div>
							<div class="right_title" style="width: 110px">
								<label class="radio-inline"> <input type="radio"
									id="optionsRadios" name="optionsRadios" value="2"
									style="margin-top: 9px;"> 未通过审核

								</label>
							</div>

							<div class="right_input" style="width: 200px;">
								<textarea id="notPassCause" name="notPassCause"
									class="form-control input-sm" rows="4" style="width: 360px;"
									data-bvalidator="maxlength[200]" placeholder="未通过原因 "></textarea>
							</div>
						</div>


						<div class="right_inline" style="padding-left: 30px;"></div>
					</div>
					<div class="right_inline ">
						
						<button type="button" id="btnSubmit"
							class="btn btn-info pull-right  btn-sm"
							style="margin: 5px 15px 0 0;">保存</button>
						<button type="button" onClick="back()"
							class="btn btn-info pull-right  btn-sm"
							style="margin: 5px 15px 0 0;">返回</button>
					</div>
				</div> -->
			</div>
...
<script>
		$(document).ready(function(){
			...
			$('#productBtn').click(function(){
				$('#productPanel').is(':hidden')? $('#productPanel').show(): $('#productPanel').hide();
			});
