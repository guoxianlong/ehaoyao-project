...
<body>
	<form method="post" name="form" action="<%=request.getContextPath()%>/platform.do?method=save">
       
		<div class="right_box" id="ll">
		<div class="right_h right_bg" >平台的创建</div>
		<div class="right_box_l">
			<div class="right_inline">
				<div class="right_title">名称</div>
				<div class="right_input" style="width:300px;"><input id="platformName" name="platformName" type="text"  class="form-control input-sm"></div>
			</div>
			
			<div class="right_inline">
				<div class="right_title">编码</div>
				<div class="right_input" style="width:300px;"><input id="platformCode" name="platformCode" type="text" class="form-control input-sm"></div>
			</div>
