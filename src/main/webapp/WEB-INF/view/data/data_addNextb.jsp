...
<body>
	<form method="post" name="form" action="<%=request.getContextPath()%>/data.do?method=save1">
		...
		<div class="right_box_l">
			...
			<div class="right_inline">
				...
				<div class="right_input" style="width:300px;"><input id="attLevel" name="attLevel" type="text" value="${dataClass.attLevel +1}" class="form-control input-sm" readonly="readonly"></div>
			</div>
			...
			<div class="right_inline">
				...
				<div class="right_input" style="width:300px;">
					<select name="parentId" class="form-control input-sm" onchange="fun(this.value)">
						<option value="${dataClass.id}">${dataClass.attName}</option>
...
<script type="text/javascript">
	function fun(a){
		document.getElementById("attLevel").value = ${dataClass.attLevel +1};
	}
