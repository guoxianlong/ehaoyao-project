...
<script type="text/javascript">
	...
	function checkName( flag ){
		...
		$.ajax( {   
		     type : "POST",   
		     url : "<%=request.getContextPath()%>/applyPlatform.do?method=checkName&name=" + name,   
		     dataType: "json",   
		     async : flag,
...
<body>
	<form id="permForm" action="<%=request.getContextPath()%>/applyPlatform.do?method=save"
		method="post">
		<div class="right_box" id="ll"></div>
		<div class="right_h right_bg">创建应用平台信息</div>
		...
		<div id="namediv" class="right_inline">
			...
			<div class="right_input" style="width:300px;">
				<input id="name" name="name" onfocus="removeCss('namediv')"  onblur="checkName(true)" data-bvalidator="maxlength[50],required"  type="text" placeholder="应用平台信息" class="form-control input-sm">
			</div>
		</div>
		<div id="urldiv" class="right_inline">
			<div class="right_title">url</div>
			<div class="right_input" style="width:300px;">
				<input id="url" name="url" onfocus="removeCss('urldiv')"  onblur="checkUrl(true)"  placeholder="/xxxx.do" class="form-control input-sm" />
			</div>
		</div>
		<div id="urldiv" class="right_inline">
			<div class="right_title">说明</div>
			<div class="right_input" style="width:300px;">
				<input id="comment" name="comment" class="form-control input-sm" />
			</div>
		</div>
