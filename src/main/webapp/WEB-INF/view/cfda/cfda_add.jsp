...
<body>
	<form method="post" name="form" action="<%=request.getContextPath()%>/cfda.do?method=save" onsubmit="return check()">
		...
		<div class="right_box_l">
			...
			<div class="right_inline">
				...
				<div class="right_input" style="width:300px;"><input id="classLevel" name="classLevel" type="text" value="1" class="form-control input-sm" readonly="readonly"></div>
			</div>
