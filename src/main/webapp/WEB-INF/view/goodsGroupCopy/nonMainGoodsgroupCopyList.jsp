...
<body>
<form action="goodsp.do?method=nonMainGroupGoodsCopyList" name="form" method="post">
...
<div class="right_title"></div>
 ...
 <!--  
 <button type="button" onclick="taocanfbplshangjia()" class="btn btn-info   btn-xs margin3" >批量上架</button> <button type="button" onclick="taocanfbplxiajia()" class="btn btn-info   btn-xs margin3" >批量下架</button></div>
 -->
...
-->
 ...
 <input type="checkbox" name="checkgroup" value="${item.id}">
    ...
    <td style="white-space:nowrap;text-align: left;"><button type="button" onClick="seedetailed('${item.id }','${item.goodsId }')" class="btn btn-success   btn-xs"   >查看</button>
    </td>
     <!--  
