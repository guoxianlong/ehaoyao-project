...
<body>
	...
	<div class="right_box">
    	<div class="right_h right_bg" >套餐副本图片编辑</div>
...
//设置保存
 function saveshezhi(){
	 ...
	 $.ajax({
    			...
    			url:"<%=request.getContextPath()%>/goodsImage.do?method=saveimagetcfbshezhi&maid="+maid+"&futuimage1="+futuimage1+"&futuimage2="+futuimage2+"&futuimage3="+futuimage3+"&futuimage4="+futuimage4+"&futuimage5="+futuimage5+"&id="+id,
    			success: function(data){
    			
    	          $.each(data,function(i,result){  
	            	alert(result);
	            	document.shezhiform.action = "goodsImage.do?method=tcfbload&wtype=6";
	 ...
	 //document.shezhiform.action="goodsImage.do?method=saveimagetcfbshezhi&maid="+maid+"&futuimage1="+futuimage1+"&futuimage2="+futuimage2+"&futuimage3="+futuimage3+"&futuimage4="+futuimage4+"&futuimage5="+futuimage5;
	 //document.shezhiform.submit();
 }
 //设置保存
	 ...
	 if(maid==""){
	  ...
	  $.ajax({
    			...
    			success: function(data){
    	          ...
    	          $.each(data,function(i,result){  
	            	alert(result);
	            	document.shezhiform.action = "goodsImage.do?method=tcfbload&wtype=5";
	                document.shezhiform.submit();
	 ...
	 $(window).scroll(function(){
		...
		$('#uploadSquare').click(function(){
			...
			$('[name=square]').change(function(){
				...
				document.formSquare.action="goodsImage.do?method=saveimageztcfb";
		...
		$('#uploadRectangle').click(function(){
			...
			$('[name=rectangle]').change(function(){
				document.formRectangle.action="goodsImage.do?method=saveimagectcfb";
				console.log($(this).val());
