...
function uptateQuality(){
	...
	if(val==null){
		...
		if(window.confirm('你确定要质检吗？')){
			 document.form.action = "goodsGroup.do?method=uptateQualityfb&val="+val;
			 document.form.submit();
			}else{
				 return false;
			}
...
<div class="right_input" style="width:130px;"><input  type="text" id="notPassCause" name="notPassCause" class="form-control input-sm" placeholder="未通过原因 "></div>
</div>
<p>
