...
<body>
	<form method="post" name="form" action="<%=request.getContextPath()%>/labels.do?method=save" onsubmit="return check();">
		...
		<div class="right_box_l">
			...
			<div class="right_inline">
				...
				<div class="right_input" style="width:300px;"><input id="labelLevel" name="labelLevel" type="text" value="1" class="form-control input-sm" readonly="readonly"></div>
			</div>
...
<script type="text/javascript">
	function fun(a){
		if(a==0){
			document.getElementById("labelLevel").value = 1;
		}else{
			document.getElementById("labelLevel").value = 2;
		}
	}
