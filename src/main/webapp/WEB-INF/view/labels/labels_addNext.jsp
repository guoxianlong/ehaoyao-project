...
<body>
	<form method="post" name="form" action="<%=request.getContextPath()%>/labels.do?method=save1">
		...
		<div class="right_box_l">
			...
			<div class="right_inline">
				...
				<div class="right_input" style="width:300px;"><input id="labelLevel" name="labelLevel" type="text" value="2" class="form-control input-sm" readonly="readonly"></div>
			</div>
...
<script type="text/javascript">
	function fun(a,b){
		var b = ${labelsClass.id};
		if(a==b){
			document.getElementById("labelLevel").value = 1 + 1;
		}else{
			document.getElementById("labelLevel").value = 1 + 2;
		}
	}
