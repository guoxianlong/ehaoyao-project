...
<body>
	<form method="post" name="form" action="<%=request.getContextPath()%>/labels.do?method=save2&id=${parentId}">
		...
		<div class="right_box_l">
			...
			<div class="right_inline">
				...
				<div class="right_input" style="width:300px;">
					...
					<input id="parentId" name="" type="text" value="${labelsClass.labelName}" class="form-control input-sm" readonly="readonly">
				</div>
			</div>
