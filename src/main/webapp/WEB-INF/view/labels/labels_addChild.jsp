...
<body>
	<form method="post" name="form" action="<%=request.getContextPath()%>/labels.do?method=save&id=${parentId}">

		<div class="right_box" id="ll">
		<div class="right_h right_bg" >标签分类子节点信息创建</div>
		<div class="right_box_l">
			...
			<div class="right_inline">
				...
				<input type = "hidden" name="parentId" value="${labelsClass.id }" />
				<div class="right_input" style="width:300px;"><input id="parentId" name="" type="text" value="${labelsClass.labelName}" class="form-control input-sm" readonly="readonly"></div>
			</div>
